...
public class Oauth1 {
	...
	String accessToken=js.getString("access_token");
		...
		GetCourses gc=given().queryParam("access_token", accessToken).expect().defaultParser(Parser.JSON)//to tell we are expecting json
		.when()
		.get("https://rahulshettyacademy.com/getCourse.php").as(GetCourses.class);
		//using (GetCourses.class) automatically response will be converted to json
		...
		//Get the price of course title "SoapUI Webservices testing"
